...
from alerts.run_alerts import run_all_checks

app = FastAPI()

ALERT_SECRET = os.getenv("ALERT_SECRET", "changeme")
...
@app.get("/trigger-alerts")
def trigger_alerts(key: str):
    if key != ALERT_SECRET:
        return {"error": "Unauthorized"}
    run_all_checks()
    return {"status": "Alerts checked and sent"}
